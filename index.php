...
// Bcrypt hash only — plaintext passwords are no longer accepted
if (empty($FREELoader_PASSWORD_HASH) || !is_string($FREELoader_PASSWORD_HASH)) {
    die('Invalid configuration: password hash missing. Re-run the installer.');
}
