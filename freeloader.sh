#!/bin/bash
# ================================================
# Freeloader Installer for Supermon / ASL3
# Pulls from https://github.com/n5ad/freeloader
# Created by N5AD - June/July 2026
# Updated with Edit/Open/Save feature for conf/ini/php/sh etc.
# ================================================
set -e
...
cp /tmp/freeloader/freeloader_download.php /var/www/html/freeloader/
cp /tmp/freeloader/index.php /var/www/html/freeloader/
...
echo " Access at: http://your-server/freeloader/"
echo "=================================================="
